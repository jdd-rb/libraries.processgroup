...
type processAction func(process Process)
	...
	type ProcessGroup struct {
		...
		// Show any errors on the console
		ShowErrors bool

		// Show any log entries on the console
		ShowLog bool
	...
	func (pg *ProcessGroup) GetLog() []struct{ Date time.Time; Process, Event string } {
	...
	// Sleep for the specified number of seconds. If this returns false, the process has ended and your function should return at the earliest opportunity
	func (p *Process) Sleep(seconds int) bool {
